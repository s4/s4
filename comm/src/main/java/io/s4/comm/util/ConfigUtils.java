...
public class ConfigUtils {
	public static List<Map<String,String>> readConfig(String configFilename, String clusterName,
				ClusterType clusterType, boolean isStatic) {
	...
	public static List<Map<String,String>> readConfig(Cluster cluster, String clusterName,
	                                           ClusterType clusterType, boolean isStatic) {
